...
/* Auto-link pragma removed: Bazel supplies python27.if.lib explicitly
   via additional_linker_inputs / linkopts; the pragma would cause
   LNK1104 because python27.lib does not exist in any search path. */
