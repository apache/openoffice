    ...
    const bool bIsEnabled)
{
    ...
    {
        const SvxHorJustifyItem* pItem = eState >= SFX_ITEM_DEFAULT ? dynamic_cast< const SvxHorJustifyItem* >(pState) : 0;
    ...
    {
        const SvxVerJustifyItem* pItem = eState >= SFX_ITEM_DEFAULT ? dynamic_cast< const SvxVerJustifyItem* >(pState) : 0;
    ...
    {
        const SfxUInt16Item* pItem = eState >= SFX_ITEM_DEFAULT ? dynamic_cast< const SfxUInt16Item* >(pState) : 0;
    ...
    {
        const SfxBoolItem* pItem = eState >= SFX_ITEM_DEFAULT ? dynamic_cast< const SfxBoolItem* >(pState) : 0;
