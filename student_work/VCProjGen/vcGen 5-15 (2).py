...
def groupChild(cmdGroup):
        ...
        for cmd in compileCmds:
                ...
                for linkCmd in linkCmds:
                        #print linkCmd[1],cmd[2]
                        if (union(linkCmd[1],cmd[2]) != []):
                                print "Match found: ",linkCmd[1],cmd[2]
        ...
        for resultCmd in resultCmds:
                ...
                if resultCmd[1][3] == "link":
                        patchVCProjExeDll(prjName,files,arguments,exeArgs,cfgType,objOut,outputFile,mapName)
                elif resultCmd[1][3] == "lib":
                        patchVCProjLib(prjName,files,arguments,libArgs,objOut,allLibFiles,outputFile)
...
def patchVCProjLib(prjName,files,arguments,libArgs,objOut,allLibFiles,libOut):
