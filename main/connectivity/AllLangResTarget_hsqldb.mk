...
$(eval $(call gb_AllLangResTarget_add_srs,hsqldb,connectivity/hsqldb))

$(eval $(call gb_SrsTarget_SrsTarget,connectivity/hsqldb))

$(eval $(call gb_SrsTarget_set_include,connectivity/hsqldb,\
	$$(INCLUDE) \
...
$(eval $(call gb_SrsTarget_add_files,connectivity/hsqldb,\
