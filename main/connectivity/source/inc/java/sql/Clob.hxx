...
namespace connectivity
{
	...
	public:
		...
		virtual ::rtl::OUString SAL_CALL getSubString( sal_Int64 pos, sal_Int32 length );
		virtual ::com::sun::star::uno::Reference< ::com::sun::star::io::XInputStream > SAL_CALL getCharacterStream(  );
		virtual sal_Int64 SAL_CALL position( const ::rtl::OUString& searchstr, sal_Int32 start );
		virtual sal_Int64 SAL_CALL positionOfClob( const ::com::sun::star::uno::Reference< ::com::sun::star::sdbc::XClob >& pattern, sal_Int64 start );
	};
}
