...
namespace connectivity
{
	namespace ado
	{
        ...
        class ODatabaseMetaData : public ODatabaseMetaDataBase
		{
            ...
            ::rtl::OUString getStringProperty(const ::rtl::OUString& _aProperty);
            sal_Int32       getInt32Property(const ::rtl::OUString& _aProperty);
            sal_Bool        getBoolProperty(const ::rtl::OUString& _aProperty);
