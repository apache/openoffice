...
public:
	...
	bool	notify( const ::com::sun::star::lang::EventObject& _rEvent );
...
protected:
	virtual bool implTypedNotify( const ::com::sun::star::uno::Reference< ::com::sun::star::awt::XPaintListener >& rListener, const ::com::sun::star::awt::PaintEvent& rEvent );
};
...
public:
	...
	virtual void SAL_CALL paint( const ::com::sun::star::awt::PaintEvent& e );

	// XSlideShowView methods
	virtual ::com::sun::star::uno::Reference< ::com::sun::star::rendering::XSpriteCanvas > SAL_CALL getCanvas(  );
	virtual void SAL_CALL clear(  );
	virtual ::com::sun::star::geometry::AffineMatrix2D SAL_CALL getTransformation(  );
	virtual void SAL_CALL addTransformationChangedListener( const ::com::sun::star::uno::Reference< ::com::sun::star::util::XModifyListener >& xListener );
	virtual void SAL_CALL removeTransformationChangedListener( const ::com::sun::star::uno::Reference< ::com::sun::star::util::XModifyListener >& xListener );
