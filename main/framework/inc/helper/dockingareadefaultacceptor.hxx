						                ...
						                public ::cppu::WeakImplHelper1< ::com::sun::star::ui::XDockingAreaAcceptor >
{
    public:
		...
		*//*-*****************************************************************************************************/
        ...
        virtual sal_Bool SAL_CALL requestDockingAreaSpace( const css::awt::Rectangle& RequestedSpace );
        virtual void SAL_CALL setDockingAreaSpace( const css::awt::Rectangle& BorderSpace );
