    ...
    , public  ::cppu::OWeakObject
{
    ...
    public:
        ...
        // XDispatchRecorder
        virtual void SAL_CALL            startRecording         ( const css::uno::Reference< css::frame::XFrame >& xFrame );
        virtual void SAL_CALL            recordDispatch         ( const css::util::URL& aURL, const css::uno::Sequence< css::beans::PropertyValue >& lArguments );
        virtual void SAL_CALL            recordDispatchAsComment( const css::util::URL& aURL, const css::uno::Sequence< css::beans::PropertyValue >& lArguments );
        virtual void SAL_CALL            endRecording           ();
        virtual ::rtl::OUString SAL_CALL getRecordedMacro       ();
	...
	virtual com::sun::star::uno::Any SAL_CALL getByIndex(sal_Int32);

	virtual void SAL_CALL replaceByIndex(sal_Int32, const com::sun::star::uno::Any&);
