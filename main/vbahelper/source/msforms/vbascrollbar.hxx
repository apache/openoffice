...
public:
   ...
   // Attributes
    ...
    virtual ::sal_Int32 SAL_CALL getMax();
    virtual void SAL_CALL setMax( ::sal_Int32 _max );
    virtual ::sal_Int32 SAL_CALL getMin();
    virtual void SAL_CALL setMin( ::sal_Int32 _min );
    virtual ::sal_Int32 SAL_CALL getLargeChange();
    virtual void SAL_CALL setLargeChange( ::sal_Int32 _largechange );
    virtual ::sal_Int32 SAL_CALL getSmallChange();
    virtual void SAL_CALL setSmallChange( ::sal_Int32 _smallchange );
