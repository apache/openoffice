...
public:
    ...
    // Attribute
	virtual double SAL_CALL getTopMargin();
	virtual void SAL_CALL setTopMargin( double margin );
	virtual double SAL_CALL getBottomMargin();
	virtual void SAL_CALL setBottomMargin( double margin );
	virtual double SAL_CALL getRightMargin();
	virtual void SAL_CALL setRightMargin( double margin );
	virtual double SAL_CALL getLeftMargin();
	virtual void SAL_CALL setLeftMargin( double margin );
