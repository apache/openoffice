...
public:
	...
	// XTable
    virtual ::com::sun::star::uno::Reference< ::com::sun::star::table::XCellCursor > SAL_CALL createCursor(  );
    virtual ::com::sun::star::uno::Reference< ::com::sun::star::table::XCellCursor > SAL_CALL createCursorByRange( const ::com::sun::star::uno::Reference< ::com::sun::star::table::XCellRange >& Range );
	...
	// XBroadcaster
	virtual void SAL_CALL lockBroadcasts();
	virtual void SAL_CALL unlockBroadcasts();
