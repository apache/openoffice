...
static inline ::System::Object ^ to_cli_constant( Any const & value )
{
	...
	{
	case TypeClass_CHAR:
		return (::System::Object ^)((::System::Char) *reinterpret_cast< sal_Unicode const * >(
				value.getValue() ));
	case TypeClass_BOOLEAN:
		return (::System::Object ^)((::System::Boolean)
			 sal_False != *reinterpret_cast< sal_Bool const * >(
				 value.getValue() ));
	case TypeClass_BYTE:
		return (::System::Object ^)((::System::Byte) *reinterpret_cast< sal_Int8 const * >(
				value.getValue() ));
	case TypeClass_SHORT:
		return (::System::Object ^)((::System::Int16) *reinterpret_cast< sal_Int16 const * >(
				value.getValue() ));
	case TypeClass_UNSIGNED_SHORT:
		return (::System::Object ^)((::System::UInt16) *reinterpret_cast< sal_uInt16 const * >(
				value.getValue() ));
	case TypeClass_LONG:
		return (::System::Object ^)((::System::Int32) *reinterpret_cast< sal_Int32 const * >(
				value.getValue() ));
	case TypeClass_UNSIGNED_LONG:
		return (::System::Object ^)((::System::UInt32) *reinterpret_cast< sal_uInt32 const * >(
				value.getValue() ));
	case TypeClass_HYPER:
		return (::System::Object ^)((::System::Int64) *reinterpret_cast< sal_Int64 const * >(
				value.getValue() ));
	case TypeClass_UNSIGNED_HYPER:
		return (::System::Object ^)((::System::UInt64) *reinterpret_cast< sal_uInt64 const * >(
				value.getValue() ));
	case TypeClass_FLOAT:
		return (::System::Object ^)((::System::Single) *reinterpret_cast< float const * >(
				value.getValue() ));
	case TypeClass_DOUBLE:
		return (::System::Object ^)((::System::Double) *reinterpret_cast< double const * >(
				value.getValue() ));
	default:
...
::System::Type ^ TypeEmitter::get_type_Exception()
{
	if (nullptr == m_type_Exception)
	{
		...
		if (nullptr == m_type_Exception)
		{
			...
			// .ctor
			cli::array< ::System::Type ^ > ^ param_types =
				  gcnew cli::array< ::System::Type ^ >( 2 );
			...
			code->Emit( Emit::OpCodes::Ldarg_0 );
			code->Emit( Emit::OpCodes::Ldarg_1 );
			param_types = gcnew cli::array< ::System::Type ^ >( 1 );
			param_types[ 0 ] = ::System::String::typeid;
			code->Emit(
				Emit::OpCodes::Call,
				::System::Exception::typeid
...
//				 (::System::Object ^)((::System::Int32) enum_values[ enum_pos ]) );
	...
	Reference< reflection::XInterfaceTypeDescription2 > const & xType )
{
	...
	if (nullptr == ret_type)
	{
		...
		if (seqBaseTypes.getLength() > 0)
		{
			...
			cli::array< ::System::Type ^ > ^ base_interfaces =
				  gcnew cli::array< ::System::Type ^ >( vecBaseTypes.size() );
...
//#endif
		...
		if (TypeClass_INTERFACE_METHOD == xMember->getTypeClass())
		{
			...
			cli::array< ::System::Type ^ > ^ param_types =
				  gcnew cli::array< ::System::Type ^ >( params_length );
...
//			 else
			...
			if (xReturnStruct.is())
			{
				...
				if (seq_type_args.getLength() != 0)
				{
					...
					cli::array< ::System::Type ^ > ^ arCtor = {::System::Type::GetType("System.Type[]")};
					...
					cli::array< ::System::Type ^ > ^ arCtsTypes = gcnew cli::array< ::System::Type ^ >( numTypes );
					for (int i = 0; i < numTypes; i++)
						arCtsTypes[i] = get_type(arXTypeArgs[i]);
					cli::array< ::System::Object ^ > ^ arArgs = {arCtsTypes};
			...
			if (xMethod->isOneway())
			{
				cli::array< ::System::Type ^ > ^ arCtorOneway = gcnew cli::array< ::System::Type ^ >( 0 );
				cli::array< ::System::Object ^ > ^ arArgs = gcnew cli::array< ::System::Object ^ >( 0 );
				Emit::CustomAttributeBuilder ^ attrBuilder =
					gcnew Emit::CustomAttributeBuilder(
		...
		else // attribute
		{
			...
			if (xAttribute->isBound())
			{
				...
				Emit::CustomAttributeBuilder ^ attrBuilderBound =
					gcnew Emit::CustomAttributeBuilder(
						ctorBoundAttr, gcnew cli::array< ::System::Object ^ >( 0 ));
			...
			{
				// setter
				parameters = gcnew cli::array< ::System::Type ^ >( 1 );
...
::System::Type ^ TypeEmitter::complete_struct_type( struct_entry ^ entry )
{
	...
	if (xStructTypeDesc.is())
	{
		...
		{
			cli::array< ::System::Object ^ > ^ aArg = gcnew cli::array< ::System::Object ^ >( numTypes );
			for (int i = 0; i < numTypes; i++)
				aArg[i] = ustring_to_String(seq_type_parameters.getConstArray()[i]);
			cli::array< ::System::Object ^ > ^ args = {aArg};

			cli::array< ::System::Type ^ > ^ arTypesCtor =
	...
	if (nullptr != entry->m_base_type)
	{
		...
		base_type_entry =
			dynamic_cast< struct_entry ^ >(
				m_generated_structs[ entry->m_base_type->FullName ] );
	}
	...
	cli::array< ::System::String ^ > ^ all_member_names =
		gcnew cli::array< ::System::String ^ >( all_members_length + members_length );
	cli::array< ::System::Type ^ > ^ all_param_types =
		gcnew cli::array< ::System::Type ^ >( all_members_length + members_length );
	member_pos = 0;
	...
	// build up entry
//	struct_entry ^ entry = gcnew struct_entry();
	entry->m_member_names = gcnew cli::array< ::System::String ^ >( members_length );
	entry->m_param_types = gcnew cli::array< ::System::Type ^ >( members_length );

	// add members
	cli::array< Emit::FieldBuilder ^ > ^ members = gcnew cli::array< Emit::FieldBuilder ^ >( members_length );
	//Reference< reflection::XTypeDescription > const * pseq_members =
	//	seq_members.getConstArray();
	//OUString const * pseq_member_names =
	//	seq_member_names.getConstArray();
	...
	for ( member_pos = 0; member_pos < members_length; ++member_pos )
	{
		...
		if (bParameterizedType && xStructTypeDesc.is())
		{
			...
			cli::array< ::System::Object ^ > ^ args = {sTypeName};
			//set ParameterizedTypeAttribute
			cli::array< ::System::Type ^ > ^ arCtorTypes = {::System::String::typeid};
	...
	code->Emit(
		...
		? entry->m_base_type->GetConstructor( gcnew cli::array< ::System::Type ^ >( 0 ) )
	...
	cli::array< ::System::Type ^ > ^ param_types =
		gcnew cli::array< ::System::Type ^ >( base_members_length );
...
::System::Type ^ TypeEmitter::complete_service_type(service_entry ^ entry)
{
	...
	ilGen->Emit(
			Emit::OpCodes::Call,
			type_builder->BaseType->GetConstructor(gcnew cli::array< ::System::Type ^ >( 0 )));
	...
	cli::array< ::System::Type ^ > ^ arTypeCtor = {::System::String::typeid,
										 ::System::Object::typeid};
	...
	for (int i = seqCtors.getLength() - 1; i >= 0; i--)
	{
		...
		cli::array< ::System::Type ^ > ^ arTypeParameters = gcnew cli::array< ::System::Type ^ >( cParams + 1 );
		...
		for (int iparam = 0; iparam != cParams; iparam++)
		{
			if (arXParams[iparam]->isRestParameter())
				arTypeParameters[iparam + 1] = cli::array< ::uno::Any >::typeid;
			else
		...
		cli::array< ::System::Type ^ > ^ arParamTypes = gcnew cli::array< ::System::Type ^ >( cParams + 1 );
...
//			arTypeParameters);
		...
		cli::array< Emit::ParameterBuilder ^ > ^ arParameterBuilder =
			gcnew cli::array< Emit::ParameterBuilder ^ >( cParams );
		for (int iparam = 0; iparam != cParams; iparam++)
		{
			...
			if (aParam->isRestParameter())
			{
				...
				Emit::CustomAttributeBuilder ^ attr_builder =
					gcnew Emit::CustomAttributeBuilder(ctor_info, gcnew cli::array< ::System::Object ^ >( 0 ));
		...
		else
		{
			...
			// and Any is created.
			cli::array< Emit::LocalBuilder ^ > ^ arLocalAny = gcnew cli::array< Emit::LocalBuilder ^ >( cParams );
			...
			Emit::LocalBuilder ^ local_anyParams =
				ilGen->DeclareLocal(cli::array< ::uno::Any >::typeid);
			...
			cli::array< ::System::Type ^ > ^ arTypesCtorAny = {::System::Type::typeid,
													::System::Object::typeid};
			...
			for (int i = 0; i < arLocalAny->Length; i ++)
			{
				...
				if (polyType)
				{
					...
					cli::array< ::System::Type ^ > ^ arTypeParams = {::System::RuntimeTypeHandle::typeid};
					...
					cli::array< ::System::Type ^ > ^ arTypeParam_GetType = {
		...
		if (arExceptionTypes->Contains(type_uno_exception) == false)
		{
			...
			cli::array< ::System::Type ^ > ^ arConcatParams = {System::String::typeid,
	...
	const Sequence<Reference< reflection::XCompoundTypeDescription > >& seq_exceptionsTd )
{
	...
	cli::array< ::System::Type ^ > ^ arTypesCtor = {::System::Type::GetType("System.Type[]")};
	...
	if (exc_length != 0) // opt
	{
		cli::array< ::System::Type ^ > ^ exception_types =
			  gcnew cli::array< ::System::Type ^ >( exc_length );
		...
		cli::array< ::System::Object ^ > ^ args = {exception_types};
...
::System::Type ^ TypeEmitter::complete_singleton_type(singleton_entry ^ entry)
{
	...
	//define method
	cli::array< ::System::Type ^ > ^ arTypeParameters = {get_type("unoidl.com.sun.star.uno.XComponentContext", true)};
	Emit::MethodBuilder ^ method_builder = type_builder->DefineMethod(
...
//		 method_builder->SetCustomAttribute(get_service_ctor_method_attribute(ctorDes));
	...
	ilGen->Emit(Emit::OpCodes::Ldstr, sBuilder->ToString());
	ilGen->Emit(Emit::OpCodes::Ldarg_0);
	cli::array< ::System::Type ^ > ^ arTypesCtorDeploymentException = {
...
TypeEmitter::TypeEmitter(
	...
	cli::array< ::System::Reflection::Assembly ^ > ^ extra_assemblies )
...
{
	cli::array< ::System::Type ^ > ^ param_types = gcnew cli::array< ::System::Type ^ >( 1 );
