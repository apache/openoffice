...
// 					". OID: {1}", m_type->ToString(), m_oid);
    ...
    srrm::IMessage* retVal= new srrm::ReturnMessage(
        retMethod, gcgcnew cli::array< System::Object ^ >( 0 ), 0, context, mcm);
    return retVal;
}
            ...
            if (typelib_TypeClass_INTERFACE_METHOD == member_type->eTypeClass)
            {
                if ((usMethodName.getLength() == remainder
                    ...
                    && usTypeName.match(usMethodName, offset))
                 {
                    ...
                    cli::array< System::Object ^ > ^ args = static_cast<System::Object ^[]>(
                        props[ m_ArgsString ]);
                    cli::array< System::Type ^ > ^ argTypes = static_cast<System::Type ^[]>(
    ...
    srrm::IMessage* msg, System::Object ^ exc)
{
    ...
    else
    {
        ...
        if (args != NULL)
        {
            ...
            cli::array< System::Object ^ > ^ arOut= gcgcnew cli::array< System::Object ^ >( mtd->nParams );
			int nOut = 0;
