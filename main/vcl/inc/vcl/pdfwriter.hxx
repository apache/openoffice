...
public:
	...
	enum ErrorCode
	{
		// transparent object occurred and was drawn opaque because
		...
		// to remove transparencies from the output
	...
	public:
		...
		rtl::OUString		Description;// descriptive text for the control (e.g. for tool tip)
 ...
 */
	...
	struct PDFWriterContext
	{
		...
		/*  determines in which format a form will be submitted. */
	...
	*/
	...
	behavior; after calling <code>BeginTransparencyGroup</code> all drawing
	operations will be grouped together into a transparent object.

	The transparency behavior is set with ond of the <code>EndTransparencyGroup</code>
	...
	Transparency is a feature introduced in PDF 1.4, so transparency group
	...
	@param bIsTrueColor
	true: jpeg is 24 bit true color, false: jpeg is 8 bit grayscale
	...
	be either 1 bit black&white or 8 bit gray
	 */
