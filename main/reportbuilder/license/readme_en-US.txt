...
This software offered by ASF will enhance Apache OpenOffice. The following features will be added:
...
* A recent version of Apache OpenOffice
...
You find complete instructions on using the Report Builder in the application help that is installed with Apache OpenOffice. Press F1 to open the Help Viewer, then enter the words "Report Builder" in the Index text box.
