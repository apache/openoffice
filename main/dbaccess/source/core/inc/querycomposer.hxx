...
namespace dbaccess
{
	...
	public:
		...
		virtual ::rtl::OUString SAL_CALL getComposedQuery(  );
		...
		virtual void SAL_CALL appendFilterByColumn( const ::com::sun::star::uno::Reference< ::com::sun::star::beans::XPropertySet >& column );
