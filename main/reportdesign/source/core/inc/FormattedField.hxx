...
namespace reportdesign
{
	...
	public:
		...
		// XFormattedField
		virtual ::sal_Int32 SAL_CALL getFormatKey();
        virtual void SAL_CALL setFormatKey(::sal_Int32 the_value);
		virtual ::com::sun::star::uno::Reference< ::com::sun::star::util::XNumberFormatsSupplier > SAL_CALL getFormatsSupplier();
	    virtual void SAL_CALL setFormatsSupplier( const ::com::sun::star::uno::Reference< ::com::sun::star::util::XNumberFormatsSupplier >& _formatssupplier );
