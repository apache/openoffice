...
::rtl::OUString SAL_CALL clazz::getName() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return (arg).m_sName; \
} \
void SAL_CALL clazz::setName( const ::rtl::OUString& _name ) \
{ \
...
::com::sun::star::uno::Sequence< ::rtl::OUString > SAL_CALL clazz::getMasterFields() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return (arg).m_aMasterFields; \
} \
void SAL_CALL clazz::setMasterFields( const ::com::sun::star::uno::Sequence< ::rtl::OUString >& _masterfields )\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	set(PROPERTY_MASTERFIELDS,_masterfields,(arg).m_aMasterFields); \
} \
::com::sun::star::uno::Sequence< ::rtl::OUString > SAL_CALL clazz::getDetailFields()\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return (arg).m_aDetailFields; \
} \
void SAL_CALL clazz::setDetailFields( const ::com::sun::star::uno::Sequence< ::rtl::OUString >& _detailfields )\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
...
void SAL_CALL clazz::setMasterFields( const ::com::sun::star::uno::Sequence< ::rtl::OUString >& )\
{ \
    throw ::com::sun::star::beans::UnknownPropertyException();\
} \
::com::sun::star::uno::Sequence< ::rtl::OUString > SAL_CALL clazz::getDetailFields()\
...
void SAL_CALL clazz::setDetailFields( const ::com::sun::star::uno::Sequence< ::rtl::OUString >&  )\
{ \
    throw ::com::sun::star::beans::UnknownPropertyException();\
}
...
{ \
 ...
 \
::rtl::OUString SAL_CALL clazz::getCharFontName() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.aFontDescriptor.Name; \
} \
 \
void SAL_CALL clazz::setCharFontName( const ::rtl::OUString& _charfontname ) \
{ \
	set(PROPERTY_CHARFONTNAME,_charfontname,varName.aFontDescriptor.Name); \
} \
 \
::rtl::OUString SAL_CALL clazz::getCharFontStyleName() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.aFontDescriptor.StyleName; \
} \
 \
void SAL_CALL clazz::setCharFontStyleName( const ::rtl::OUString& _charfontstylename ) \
{ \
...
::rtl::OUString SAL_CALL clazz::getCharCombinePrefix() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.sCharCombinePrefix; \
} \
void SAL_CALL clazz::setCharCombinePrefix(const ::rtl::OUString & the_value) \
{ \
	set(PROPERTY_CHARCOMBINEPREFIX,the_value,varName.sCharCombinePrefix); \
}\
::rtl::OUString SAL_CALL clazz::getCharCombineSuffix() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.sCharCombineSuffix; \
} \
void SAL_CALL clazz::setCharCombineSuffix(const ::rtl::OUString & the_value) \
{ \
...
::rtl::OUString SAL_CALL clazz::getHyperLinkURL() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.sHyperLinkURL; \
} \
void SAL_CALL clazz::setHyperLinkURL(const ::rtl::OUString & the_value) \
{ \
	set(PROPERTY_HYPERLINKURL,the_value,varName.sHyperLinkURL); \
}\
::rtl::OUString SAL_CALL clazz::getHyperLinkTarget() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.sHyperLinkTarget; \
} \
void SAL_CALL clazz::setHyperLinkTarget(const ::rtl::OUString & the_value) \
{ \
	set(PROPERTY_HYPERLINKTARGET,the_value,varName.sHyperLinkTarget); \
}\
::rtl::OUString SAL_CALL clazz::getHyperLinkName() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.sHyperLinkName; \
} \
void SAL_CALL clazz::setHyperLinkName(const ::rtl::OUString & the_value) \
{ \
	set(PROPERTY_HYPERLINKNAME,the_value,varName.sHyperLinkName); \
}\
::rtl::OUString SAL_CALL clazz::getVisitedCharStyleName() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.sVisitedCharStyleName; \
} \
void SAL_CALL clazz::setVisitedCharStyleName(const ::rtl::OUString & the_value) \
{ \
	set(PROPERTY_VISITEDCHARSTYLENAME,the_value,varName.sVisitedCharStyleName); \
}\
::rtl::OUString SAL_CALL clazz::getUnvisitedCharStyleName() \
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.sUnvisitedCharStyleName; \
} \
void SAL_CALL clazz::setUnvisitedCharStyleName(const ::rtl::OUString & the_value) \
{ \
...
::rtl::OUString SAL_CALL clazz::getCharFontNameAsian()\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.aAsianFontDescriptor.Name; \
}\
void SAL_CALL clazz::setCharFontNameAsian( const ::rtl::OUString& the_value )\
{ \
	set(PROPERTY_CHARFONTNAMEASIAN,the_value,varName.aAsianFontDescriptor.Name); \
}\
::rtl::OUString SAL_CALL clazz::getCharFontStyleNameAsian()\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.aAsianFontDescriptor.StyleName; \
}\
void SAL_CALL clazz::setCharFontStyleNameAsian( const ::rtl::OUString& the_value )\
{ \
...
void SAL_CALL clazz::setCharPostureAsian( ::com::sun::star::awt::FontSlant the_value )\
{ \
	set(PROPERTY_CHARPOSTUREASIAN,the_value,varName.aAsianFontDescriptor.Slant); \
}\
::com::sun::star::lang::Locale SAL_CALL clazz::getCharLocaleAsian()\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.aCharLocaleAsian; \
}\
void SAL_CALL clazz::setCharLocaleAsian( const ::com::sun::star::lang::Locale& the_value )\
{ \
    BoundListeners l; \
	{ \
		::osl::MutexGuard aGuard(m_aMutex); \
...
::rtl::OUString SAL_CALL clazz::getCharFontNameComplex()\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.aComplexFontDescriptor.Name; \
}\
void SAL_CALL clazz::setCharFontNameComplex( const ::rtl::OUString& the_value )\
{ \
	set(PROPERTY_CHARFONTNAMECOMPLEX,the_value,varName.aComplexFontDescriptor.Name); \
}\
::rtl::OUString SAL_CALL clazz::getCharFontStyleNameComplex()\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.aComplexFontDescriptor.StyleName; \
}\
void SAL_CALL clazz::setCharFontStyleNameComplex( const ::rtl::OUString& the_value )\
{ \
...
::com::sun::star::awt::FontSlant SAL_CALL clazz::getCharPostureComplex()\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.aComplexFontDescriptor.Slant; \
}\
void SAL_CALL clazz::setCharPostureComplex( ::com::sun::star::awt::FontSlant the_value )\
{ \
	set(PROPERTY_CHARPOSTURECOMPLEX,the_value,varName.aComplexFontDescriptor.Slant); \
}\
::com::sun::star::lang::Locale SAL_CALL clazz::getCharLocaleComplex()\
{ \
	::osl::MutexGuard aGuard(m_aMutex); \
	return varName.aCharLocaleComplex; \
}\
void SAL_CALL clazz::setCharLocaleComplex( const ::com::sun::star::lang::Locale& the_value )\
{ \
    BoundListeners l; \
	{ \
		::osl::MutexGuard aGuard(m_aMutex); \
...
{\
 ...
 void SAL_CALL clazz::setCharFontNameAsian( const ::rtl::OUString& )\
 {\
	throw beans::UnknownPropertyException();\
}\
 ::rtl::OUString SAL_CALL clazz::getCharFontStyleNameAsian()\
 ...
 void SAL_CALL clazz::setCharFontStyleNameAsian( const ::rtl::OUString& )\
 {\
	throw beans::UnknownPropertyException();\
}\
 ::sal_Int16 SAL_CALL clazz::getCharFontFamilyAsian()\
 ...
 void SAL_CALL clazz::setCharPostureAsian( ::com::sun::star::awt::FontSlant )\
 {\
	throw beans::UnknownPropertyException();\
}\
 ::com::sun::star::lang::Locale SAL_CALL clazz::getCharLocaleAsian()\
 ...
 void SAL_CALL clazz::setCharFontNameComplex( const ::rtl::OUString& )\
 {\
	throw beans::UnknownPropertyException();\
}\
 ::rtl::OUString SAL_CALL clazz::getCharFontStyleNameComplex()\
 ...
 void SAL_CALL clazz::setCharFontStyleNameComplex( const ::rtl::OUString& )\
 {\
	throw beans::UnknownPropertyException();\
}\
 ::sal_Int16 SAL_CALL clazz::getCharFontFamilyComplex()\
 ...
 void SAL_CALL clazz::setCharPostureComplex( ::com::sun::star::awt::FontSlant )\
 {\
	throw beans::UnknownPropertyException();\
}\
 ::com::sun::star::lang::Locale SAL_CALL clazz::getCharLocaleComplex()\
 ...
 void SAL_CALL clazz::setCharLocaleComplex( const ::com::sun::star::lang::Locale& )\
 {\
	throw beans::UnknownPropertyException();\
}
