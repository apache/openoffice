...
ScDocument* GetDocumentFromRange( const css::uno::Reference< css::uno::XInterface >& xRange );
css::uno::Reference< css::frame::XModel > GetModelFromRange( const css::uno::Reference< css::uno::XInterface >& xRange );
