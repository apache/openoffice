...
XFormsEventConcrete::XEventTarget_t SAL_CALL XFormsEventConcrete::getTarget()
{
    return m_target;
}

XFormsEventConcrete::XEventTarget_t SAL_CALL XFormsEventConcrete::getCurrentTarget()
{
    return m_currentTarget;
}

XFormsEventConcrete::PhaseType_t SAL_CALL XFormsEventConcrete::getEventPhase()
{
    return m_phase;
}
...
XFormsEventConcrete::Time_t SAL_CALL XFormsEventConcrete::getTimeStamp()
{
    return m_time;
}
