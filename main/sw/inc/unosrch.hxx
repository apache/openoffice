...
public:
	...
	//XReplaceDescriptor
	virtual ::rtl::OUString SAL_CALL getReplaceString(void);
	...
	//XPropertyReplace
	virtual sal_Bool SAL_CALL getValueSearch(void);
	virtual void SAL_CALL setValueSearch(sal_Bool ValueSearch_);
	virtual ::com::sun::star::uno::Sequence< com::sun::star::beans::PropertyValue > SAL_CALL getSearchAttributes(void);
	virtual void SAL_CALL setSearchAttributes(const ::com::sun::star::uno::Sequence< com::sun::star::beans::PropertyValue >& aSearchAttribs);
	virtual ::com::sun::star::uno::Sequence< com::sun::star::beans::PropertyValue > SAL_CALL getReplaceAttributes(void);
	virtual void SAL_CALL setReplaceAttributes(const ::com::sun::star::uno::Sequence< com::sun::star::beans::PropertyValue >& aSearchAttribs);
