...
#define CMD_FN_TABLE_VERT_BOTTOM                    ".uno:SwCellVertBottom"
#define CMD_FN_TABLE_VERT_CENTER                    ".uno:SwCellVertCenter"
#define CMD_FN_TABLE_VERT_NONE                      ".uno:SwCellVertTop"
