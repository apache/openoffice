...
SfxObjectShell* SwVbaApplication::GetDocShell( const uno::Reference< frame::XModel >& xModel )
{
...
float SAL_CALL SwVbaApplication::CentimetersToPoints( float _Centimeters )
{
