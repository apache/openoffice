...
static void implThrowIllegalArgumentException()
{
...
public:
    ...
    virtual ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XMutableTreeNode > SAL_CALL createNode( const ::com::sun::star::uno::Any& DisplayValue, ::sal_Bool ChildsOnDemand );
    virtual void SAL_CALL setRoot( const ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XMutableTreeNode >& RootNode );

    // XTreeDataModel
    virtual ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XTreeNode > SAL_CALL getRoot(  );
    virtual void SAL_CALL addTreeDataModelListener( const ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XTreeDataModelListener >& Listener );
    virtual void SAL_CALL removeTreeDataModelListener( const ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XTreeDataModelListener >& Listener );
...
public:
	...
	// XMutableTreeNode
    virtual ::com::sun::star::uno::Any SAL_CALL getDataValue();
    virtual void SAL_CALL setDataValue( const ::com::sun::star::uno::Any& _datavalue );
    virtual void SAL_CALL appendChild( const ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XMutableTreeNode >& ChildNode );
    virtual void SAL_CALL insertChildByIndex( ::sal_Int32 Index, const ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XMutableTreeNode >& ChildNode );
    virtual void SAL_CALL removeChildByIndex( ::sal_Int32 Index );
    virtual void SAL_CALL setHasChildrenOnDemand( ::sal_Bool ChildrenOnDemand );
    virtual void SAL_CALL setDisplayValue( const ::com::sun::star::uno::Any& Value );
    virtual void SAL_CALL setNodeGraphicURL( const ::rtl::OUString& URL );
    virtual void SAL_CALL setExpandedGraphicURL( const ::rtl::OUString& URL );
    virtual void SAL_CALL setCollapsedGraphicURL( const ::rtl::OUString& URL );

    // XTreeNode
    virtual ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XTreeNode > SAL_CALL getChildAt( ::sal_Int32 Index );
    virtual ::sal_Int32 SAL_CALL getChildCount(  );
    virtual ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XTreeNode > SAL_CALL getParent(  );
    virtual ::sal_Int32 SAL_CALL getIndex( const ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XTreeNode >& Node );
    virtual ::sal_Bool SAL_CALL hasChildrenOnDemand(  );
    virtual ::com::sun::star::uno::Any SAL_CALL getDisplayValue(  );
    virtual ::rtl::OUString SAL_CALL getNodeGraphicURL(  );
    virtual ::rtl::OUString SAL_CALL getExpandedGraphicURL(  );
    virtual ::rtl::OUString SAL_CALL getCollapsedGraphicURL(  );
	...
	static MutableTreeNode* getImplementation( const Reference< XTreeNode >& xNode, bool bThrows );
...
Reference< XMutableTreeNode > SAL_CALL MutableTreeDataModel::createNode( const Any& aValue, sal_Bool bChildsOnDemand )
{
...
MutableTreeNode* MutableTreeNode::getImplementation( const Reference< XTreeNode >& xNode, bool bThrows )
{
...
void SAL_CALL MutableTreeNode::setHasChildrenOnDemand( sal_Bool bChildsOnDemand )
{
	bool bChanged;
