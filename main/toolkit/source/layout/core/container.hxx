...
public:
    ...
    virtual void SAL_CALL addChild( const css::uno::Reference< css::awt::XLayoutConstrains >& Child ) = 0;
    virtual void SAL_CALL removeChild( const css::uno::Reference< css::awt::XLayoutConstrains >& Child ) = 0;

    virtual css::uno::Sequence< css::uno::Reference
                                < css::awt::XLayoutConstrains > > SAL_CALL getChildren() = 0;

    virtual css::uno::Reference< css::beans::XPropertySet > SAL_CALL getChildProperties(
        const css::uno::Reference< css::awt::XLayoutConstrains >& Child ) = 0;

    virtual void SAL_CALL allocateArea( const css::awt::Rectangle &rArea ) = 0;
    ...
    css::awt::Size SAL_CALL getRequestedSize()
    { return maRequisition; }
    com::sun::star::awt::Rectangle SAL_CALL getAllocatedArea()
    { return maAllocation; }

    virtual sal_Bool SAL_CALL hasHeightForWidth() = 0;
    virtual sal_Int32 SAL_CALL getHeightForWidth( sal_Int32 nWidth ) = 0;
    ...
    css::awt::Size SAL_CALL getPreferredSize() { return getMinimumSize(); } // TODO: use this for flow?
    css::awt::Size SAL_CALL calcAdjustedSize( const css::awt::Size& rNewSize ) { return rNewSize; }
