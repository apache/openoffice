...
DECL_LISTENERMULTIPLEXER_START( VclContainerListenerMultiplexer, ::com::sun::star::awt::XVclContainerListener )
    void SAL_CALL windowAdded( const ::com::sun::star::awt::VclContainerEvent& e );
    void SAL_CALL windowRemoved( const ::com::sun::star::awt::VclContainerEvent& e );
DECL_LISTENERMULTIPLEXER_END
...
DECL_LISTENERMULTIPLEXER_START_DLLPUB( ActionListenerMultiplexer, ::com::sun::star::awt::XActionListener )
    void SAL_CALL actionPerformed( const ::com::sun::star::awt::ActionEvent& rEvent );
DECL_LISTENERMULTIPLEXER_END
...
DECL_LISTENERMULTIPLEXER_START_DLLPUB( ItemListenerMultiplexer, ::com::sun::star::awt::XItemListener )
    void SAL_CALL itemStateChanged( const ::com::sun::star::awt::ItemEvent& rEvent );
DECL_LISTENERMULTIPLEXER_END
...
DECL_LISTENERMULTIPLEXER_START( ContainerListenerMultiplexer, ::com::sun::star::container::XContainerListener )
    void SAL_CALL elementInserted( const ::com::sun::star::container::ContainerEvent& Event );
    void SAL_CALL elementRemoved( const ::com::sun::star::container::ContainerEvent& Event );
    void SAL_CALL elementReplaced( const ::com::sun::star::container::ContainerEvent& Event );
DECL_LISTENERMULTIPLEXER_END
...
DECL_LISTENERMULTIPLEXER_START_DLLPUB( SpinListenerMultiplexer, ::com::sun::star::awt::XSpinListener )
    void SAL_CALL up( const ::com::sun::star::awt::SpinEvent& rEvent );
    void SAL_CALL down( const ::com::sun::star::awt::SpinEvent& rEvent );
    void SAL_CALL first( const ::com::sun::star::awt::SpinEvent& rEvent );
    void SAL_CALL last( const ::com::sun::star::awt::SpinEvent& rEvent );
DECL_LISTENERMULTIPLEXER_END
...
DECL_LISTENERMULTIPLEXER_START( MenuListenerMultiplexer, ::com::sun::star::awt::XMenuListener )
    void SAL_CALL itemHighlighted( const ::com::sun::star::awt::MenuEvent& rEvent );
    void SAL_CALL itemSelected( const ::com::sun::star::awt::MenuEvent& rEvent );
    void SAL_CALL itemActivated( const ::com::sun::star::awt::MenuEvent& rEvent );
    void SAL_CALL itemDeactivated( const ::com::sun::star::awt::MenuEvent& rEvent );
DECL_LISTENERMULTIPLEXER_END
...
DECL_LISTENERMULTIPLEXER_START_DLLPUB( TreeExpansionListenerMultiplexer, ::com::sun::star::awt::tree::XTreeExpansionListener )
    virtual void SAL_CALL requestChildNodes( const ::com::sun::star::awt::tree::TreeExpansionEvent& aEvent );
	virtual void SAL_CALL treeExpanding( const ::com::sun::star::awt::tree::TreeExpansionEvent& aEvent );
	virtual void SAL_CALL treeCollapsing( const ::com::sun::star::awt::tree::TreeExpansionEvent& aEvent );
    virtual void SAL_CALL treeExpanded( const ::com::sun::star::awt::tree::TreeExpansionEvent& aEvent );
    virtual void SAL_CALL treeCollapsed( const ::com::sun::star::awt::tree::TreeExpansionEvent& aEvent );
DECL_LISTENERMULTIPLEXER_END
...
DECL_LISTENERMULTIPLEXER_START_DLLPUB( TreeEditListenerMultiplexer, ::com::sun::star::awt::tree::XTreeEditListener )
    virtual void SAL_CALL nodeEditing( const ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XTreeNode >& Node );
    virtual void SAL_CALL nodeEdited( const ::com::sun::star::uno::Reference< ::com::sun::star::awt::tree::XTreeNode >& Node, const ::rtl::OUString& NewText );
DECL_LISTENERMULTIPLEXER_END
...
DECL_LISTENERMULTIPLEXER_START_DLLPUB( SelectionListenerMultiplexer, ::com::sun::star::awt::grid::XGridSelectionListener )
    void SAL_CALL selectionChanged( const ::com::sun::star::awt::grid::GridSelectionEvent& aEvent );
DECL_LISTENERMULTIPLEXER_END
...
DECL_LISTENERMULTIPLEXER_START_DLLPUB( TabPageListenerMultiplexer, ::com::sun::star::awt::tab::XTabPageContainerListener )
    void SAL_CALL tabPageActivated( const ::com::sun::star::awt::tab::TabPageActivatedEvent& aEvent );
DECL_LISTENERMULTIPLEXER_END
