...
public:
    ...
    ::com::sun::star::awt::FontDescriptor			SAL_CALL getFontDescriptor(  );
    ::com::sun::star::awt::SimpleFontMetric			SAL_CALL getFontMetric(  );
    sal_Int16										SAL_CALL getCharWidth( sal_Unicode c );
    ::com::sun::star::uno::Sequence< sal_Int16 >	SAL_CALL getCharWidths( sal_Unicode nFirst, sal_Unicode nLast );
    sal_Int32										SAL_CALL getStringWidth( const ::rtl::OUString& str );
    sal_Int32										SAL_CALL getStringWidthArray( const ::rtl::OUString& str, ::com::sun::star::uno::Sequence< sal_Int32 >& rDXArray );
    void											SAL_CALL getKernPairs( ::com::sun::star::uno::Sequence< sal_Unicode >& rnChars1, ::com::sun::star::uno::Sequence< sal_Unicode >& rnChars2, ::com::sun::star::uno::Sequence< sal_Int16 >& rnKerns );

    // ::com::sun::star::lang::XFont2
    sal_Bool                                        SAL_CALL hasGlyphs( const ::rtl::OUString& aText );
};
